...
public record class Country : IEquatable<Country>
{
    ...
    public static implicit operator Country(string abbreviation)
    {
        return All.FirstOrDefault(country => string.Equals(country.Abbreviation, abbreviation, StringComparison.Ordinal)) ?? throw new InvalidCastException();
    }
