...
namespace ApiSdk.Companies {
    ...
    public class CompaniesRequestBuilder : BaseRequestBuilder {
        ...
        public CompaniesItemRequestBuilder this[double position] { get {
            var urlTplParams = new Dictionary<string, object>(PathParameters);
            urlTplParams.Add("id", position);
            return new CompaniesItemRequestBuilder(urlTplParams, RequestAdapter);
        } }
        /// <summary>
...
#nullable enable
        public async Task<CompaniesGetResponse?> GetAsync(Action<RequestConfiguration<CompaniesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<CompaniesGetResponse> GetAsync(Action<RequestConfiguration<CompaniesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
