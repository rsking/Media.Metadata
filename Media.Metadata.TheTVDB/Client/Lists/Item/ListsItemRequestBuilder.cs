...
namespace ApiSdk.Lists.Item {
    ...
    public class ListsItemRequestBuilder : BaseRequestBuilder {
        ...
        /// <summary>
        /// Instantiates a new ListsItemRequestBuilder and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ListsGetResponse?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ListsGetResponse> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ListsItemRequestBuilder WithUrl(string rawUrl) {
            return new ListsItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
