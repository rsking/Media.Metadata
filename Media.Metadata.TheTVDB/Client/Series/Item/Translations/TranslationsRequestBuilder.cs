...
namespace ApiSdk.Series.Item.Translations
{
    ...
    public class TranslationsRequestBuilder : BaseRequestBuilder
    {
        ...
        public ApiSdk.Series.Item.Translations.Item.WithLanguageItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("language", position);
                return new ApiSdk.Series.Item.Translations.Item.WithLanguageItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Series.Item.Translations.TranslationsRequestBuilder"/> and sets the default values.
        /// </summary>
