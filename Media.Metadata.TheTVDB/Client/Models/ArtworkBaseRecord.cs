...
namespace ApiSdk.Models
{
    ...
    /// base artwork record
    /// </summary>
    public class ArtworkBaseRecord : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ArtworkBaseRecord"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ArtworkBaseRecord"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.ArtworkBaseRecord CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ArtworkBaseRecord();
        }
        /// <summary>
