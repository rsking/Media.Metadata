...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.SourceType"/> and sets the default values.
        /// </summary>
        public SourceType()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.SourceType"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.SourceType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.SourceType();
        }
        /// <summary>
