...
namespace ApiSdk.Models {
    ...
    public class SeriesAirsDays : IAdditionalDataHolder, IParsable {
        ...
        /// <summary>
        /// Instantiates a new SeriesAirsDays and sets the default values.
        /// </summary>
        ...
        public static SeriesAirsDays CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SeriesAirsDays();
        }
        /// <summary>
