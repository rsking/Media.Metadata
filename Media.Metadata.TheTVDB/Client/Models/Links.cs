...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.Links"/> and sets the default values.
        /// </summary>
        public Links()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.Links"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.Links CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.Links();
        }
        /// <summary>
