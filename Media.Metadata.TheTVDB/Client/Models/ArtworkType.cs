...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="ApiSdk.Models.ArtworkType"/> and sets the default values.
        /// </summary>
        public ArtworkType()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="ApiSdk.Models.ArtworkType"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ApiSdk.Models.ArtworkType CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ApiSdk.Models.ArtworkType();
        }
        /// <summary>
